...
- Validation: not reproducible in this environment (no access to a live Channels DVR tuner). Reporter confirmed on v1.14.6 that live channels now play immediately with no manual play-button click and no frozen frame.
